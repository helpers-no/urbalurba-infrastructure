...
explicit — [browserless-001](../completed/PLAN-service-browserless-001-deploy.md) ships
...
**Prerequisite**: [PLAN-service-browserless-001-deploy](../completed/PLAN-service-browserless-001-deploy.md)
